<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BusquedaBenchClima.aspx.vb" Inherits="ConsultaVirtual.BusquedaBenchClima" culture="auto" meta:resourcekey="PageResource1" uiculture="auto:es-MX" %>
                                              ...
                                              <tr>
                                                  <td width="100%" align="center" colspan="5" valign="top">
                                                          ...
                                                          <telerik:RadGrid ID="RadGrid1" runat="server" Height="400px" ShowFooter="True" ShowStatusBar="True" 
                                                              Width="99%" Culture="es-ES" meta:resourcekey="RadGrid1Resource1" GroupPanelPosition="Top">
                                                              ...
                                                              <MasterTableView CommandItemDisplay="Top" AutoGenerateColumns="False" TableLayout="Fixed" >
                                                                  ...
                                                                  <Columns>
                                                                      <telerik:GridBoundColumn DataField="CveEmpresa" FilterControlAltText="Filter CveEmpresa column" HeaderText="Cve" UniqueName="CveEmpresa" meta:resourcekey="GridBoundColumnResource1">
                                                                          <HeaderStyle Width="100px" />
                                                                          <ItemStyle HorizontalAlign="Center" />
                                                                      </telerik:GridBoundColumn>
                                                                      <telerik:GridBoundColumn DataField="NomEmpresa" FilterControlAltText="Filter NomEmpresa column" HeaderText="Centro de Trabajo" UniqueName="NomEmpresa" meta:resourcekey="GridBoundColumnResource2">
                                                                          <HeaderStyle Width="30%" />
                                                                          <ItemStyle HorizontalAlign="Left" />
                                                                          <FooterStyle HorizontalAlign="Left" />
                                                                      </telerik:GridBoundColumn>
                                                                      <telerik:GridBoundColumn DataField="AnioEstudio" FilterControlAltText="Filter AnioEstudio column" HeaderText="Año" UniqueName="AnioEstudio" meta:resourcekey="GridBoundColumnResource3">
                                                                          <HeaderStyle Width="5%" />
                                                                          <ItemStyle HorizontalAlign="Center" />
                                                                      </telerik:GridBoundColumn>
                                                                      <telerik:GridBoundColumn DataField="PersonasEncuestadas" FilterControlAltText="Filter PersonasEncuestadas column" HeaderText="Encuestadas" UniqueName="PersonasEncuestadas" meta:resourcekey="GridBoundColumnResource4">
                                                                          <HeaderStyle Width="10%" />
                                                                          <ItemStyle HorizontalAlign="Center" />
                                                                          <FooterStyle HorizontalAlign="Center" />
                                                                      </telerik:GridBoundColumn>
                                                                      <telerik:GridBoundColumn DataField="PersonasEmpresa" FilterControlAltText="Filter PersonasEmpresa column" HeaderText="Total" UniqueName="PersonasEmpresa" meta:resourcekey="GridBoundColumnResource5">
                                                                          <HeaderStyle Width="10%" />
                                                                          <ItemStyle HorizontalAlign="Center" />
                                                                          <FooterStyle HorizontalAlign="Center" />
                                                                      </telerik:GridBoundColumn>
                                                                      <telerik:GridBoundColumn DataField="AL" DataFormatString="{0:N1}" FilterControlAltText="Filter AL column" HeaderText="Ambiente Laboral" UniqueName="AL" meta:resourcekey="GridBoundColumnResource6">
                                                                          <HeaderStyle Width="10%" />
                                                                          <ItemStyle HorizontalAlign="Center" />
                                                                          <FooterStyle HorizontalAlign="Center" />
                                                                      </telerik:GridBoundColumn>
                                                                      <telerik:GridBoundColumn DataField="JI" DataFormatString="{0:N1}" FilterControlAltText="Filter JI column" HeaderText="Jefe Inmediato" UniqueName="JI" meta:resourcekey="GridBoundColumnResource7">
                                                                          <HeaderStyle Width="10%" />
                                                                          <ItemStyle HorizontalAlign="Center" />
                                                                          <FooterStyle HorizontalAlign="Center" />
                                                                      </telerik:GridBoundColumn>
                                                                      <telerik:GridBoundColumn DataField="CS" DataFormatString="{0:N1}" FilterControlAltText="Filter CS column" HeaderText="Compromiso y Soporte" UniqueName="CS" meta:resourcekey="GridBoundColumnResource8">
                                                                          <HeaderStyle Width="10%" />
                                                                          <ItemStyle HorizontalAlign="Center" />
                                                                          <FooterStyle HorizontalAlign="Center" />
                                                                      </telerik:GridBoundColumn>
                                                                      <telerik:GridBoundColumn DataField="CO" DataFormatString="{0:N1}" FilterControlAltText="Filter CO column" HeaderText="Clima Organizacional" UniqueName="CO" meta:resourcekey="GridBoundColumnResource9">
                                                                          <HeaderStyle Width="10%" />
                                                                          <ItemStyle HorizontalAlign="Center" />
                                                                          <FooterStyle HorizontalAlign="Center" />
                                                                      </telerik:GridBoundColumn>
