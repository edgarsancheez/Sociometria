<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GraficaMatriz.aspx.vb" Inherits="ConsultaVirtual.GraficaMatriz" meta:resourcekey="PageResource1" uiculture="auto" %>
            ...
            <tr align="center" valign="middle">
                <td>
                    ...
                    <telerik:ReportViewer ID="ReportViewer1" runat="server" Height="600px" 
                        Width="800px" meta:resourcekey="ReportViewer1Resource1" ReportBookID=""></telerik:ReportViewer>
                            </td>
                        </tr>
                    </table>
                </td>
